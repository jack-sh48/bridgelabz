...
ActiveRecord::Schema.define(version: 2023_03_07_113251) do
  ...
  create_table "bx_block_address_addresses", force: :cascade do |t|
    t.integer "pin_code"
    t.string "address"
    t.string "city"
    t.string "country"
  ...
  create_table "bx_block_banners_banners", force: :cascade do |t|
    t.string "alignment"
    t.string "border"
  ...
  create_table "bx_block_bridgelabz_speak_bridgelabz_speaks", force: :cascade do |t|
    t.string "title"
    t.string "video"
    t.string "content"
    t.text "description"
  ...
  create_table "bx_block_experiential_learning_experientials", force: :cascade do |t|
  ...
  create_table "bx_block_faq_faqs", force: :cascade do |t|
    t.string "description"
    t.string "question"
    t.string "content"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "bx_block_faqs_faqs", force: :cascade do |t|
    t.string "question"
    t.text "description"
    t.string "content"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "bx_block_forms_forms", force: :cascade do |t|
    t.string "image"
    t.string "page_title"
  ...
  create_table "bx_block_landingpage_scholarships", force: :cascade do |t|
    t.string "first_name"
    t.string "last_name"
    t.string "email"
  ...
  create_table "bx_block_news_about_us_news_abouts", force: :cascade do |t|
    t.string "title"
    t.string "sub_title"
    t.string "image"
    t.string "link"
  ...
  create_table "bx_block_story_stories", force: :cascade do |t|
    t.string "name"
    t.string "position"
    t.string "package"
    t.string "description"
  ...
  create_table "bx_block_story_testimonials", force: :cascade do |t|
    t.string "name"
  ...
  create_table "bx_block_teams_teams", force: :cascade do |t|
    t.string "name"
    t.string "position"
    t.text "description"
